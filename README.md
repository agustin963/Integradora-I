...
Cursiva: Para aplicar cursiva al texto, utiliza un solo asterisco * o un solo guión bajo _ antes y después del texto. Por ejemplo:
...
6. definir si habra exclusiones de archivo a traves del archivo *.gitignore*
7. guardar cambios
...
utilizar el estandar de HTML, usando los tags: 
\<th> para los encabezados, </tr> para las filas y <td>
...
utilizaremos la estructura de las ligas, maquetando el nombre de la imagen
